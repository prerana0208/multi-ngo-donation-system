...
<head>
    ...
    <title>NGO Login - Multi-NGO System</title>
...
<body>
    <div class="login-container">
        <h2><i class="fas fa-building-columns"></i> NGO Login</h2>
        ...
        <form action="NgoLogin" method="post">
            <div class="form-group">
                <label><i class="fas fa-envelope"></i> NGO Email</label>
        ...
        <div class="register-link">
            New NGO? <a href="ngoregister.jsp">Register here</a>
        </div>
