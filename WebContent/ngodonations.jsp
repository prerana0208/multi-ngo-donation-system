...
<head>
    ...
    <title>NGO Donations - Multi-NGO System</title>
...
<body>
    <div class="header">
        <h2><i class="fas fa-heart"></i> Received Donations (NGO ID: <%= ngoId %>)</h2>
        <div class="back-link">
            <a href="ngodashboard.jsp">
            ...
            <table>
                ...
                try {
                    ...
                    ps = con.prepareStatement(
                        "SELECT u.name, d.amount, d.date FROM donation d JOIN user u ON d.user_id = u.user_id WHERE d.ngo_id = ? ORDER BY d.date DESC"
                    );
                    ps.setInt(1, ngoId);
                    rs = ps.executeQuery();
                ...
                %>
                    <tr>
                        <td data-label="User Name"><%= rs.getString("name") %></td>
