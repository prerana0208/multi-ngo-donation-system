...
<head>
    ...
    <title>Rejected NGOs - Admin Panel</title>
...
<body>
    <!-- Header -->
    <div class="header">
        <h2><i class="fas fa-times-circle"></i> Rejected NGO List</h2>
        <div class="back-link">
        ...
        <div class="table-container">
            <table>
                ...
                try{
                    ...
                    ps = con.prepareStatement("SELECT * FROM ngo WHERE status='rejected'");
                    rs = ps.executeQuery();
                ...
                %>
                    <tr>
                        ...
                        <td data-label="Reg No"><%= rs.getString("reg_no") %></td>
